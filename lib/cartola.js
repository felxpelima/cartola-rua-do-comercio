...
// O Cartola pontua em 2 casas decimais, mas a API serializa o float com ruído
// (ex.: 145.62 chega como 145.6201171875). Arredondamos para 2 casas para bater
// com o que o Cartola mostra e evitar que a soma das rodadas acumule esse lixo
// (ex.: total 430.000078125 em vez de 430). A parcial já faz isso via toFixed(2).
...
export function extractCartolaRoundSnapshot(payload = {}, scoredPayload = null, matchesPayload = null, roundId = null) {
  ...
  const officialPoints = roundPoints(value);
